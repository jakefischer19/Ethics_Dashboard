      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row p-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="short-term-1">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-st-o1-slider" name="agg-st-o1-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-st-o1-slider-txt" name="agg-st-o1-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          <div class="row p-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="long-term-1">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-lt-o1-slider" name="agg-lt-o1-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-lt-o1-slider-txt" name="agg-lt-o1-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          <br />
          ...
          <div class="row p-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="short-term-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-st-o2-slider" name="agg-st-o2-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-st-o2-slider-txt" name="agg-st-o2-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          <div class="row p-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="long-term-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-lt-o2-slider" name="agg-lt-o2-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-lt-o2-slider-txt" name="agg-lt-o2-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          <br />
          ...
          <div class="row p-2" id="option-3-st">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="short-term-3">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-st-o3-slider" name="agg-st-o3-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-st-o3-slider-txt" name="agg-st-o3-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          <div class="row p-2" id="option-3-lt">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2" id="long-term-3">
                  Pleasure
                  <input type="range" min="1" max="100" value="50" class="slider" id="agg-lt-o3-slider" name="agg-lt-o3-slider" disabled />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="agg-lt-o3-slider-txt" name="agg-lt-o3-slider-txt" class="text-class" placeholder="Higher Lower" disabled />
              </div>
            </div>
          </div>
          ...
          <div class="row p-2">
            ...
            <h5 class="p-2">
              <textarea name="course-of-action-txt" id="course-of-action-txt" cols="10" rows="7" placeholder="Although Option 1 produces pleasures in the short-term , they are lower pleasures.

  Option 2 results in less overall pain and higher pleasures to the stakeholders most impacted by the issue.

  Option 2 will produce the greatest happiness and is therefore the right option."></textarea>
            </h5>

            <div class="row justify-content-center">
              <input type="submit" value="Save" onclick="unhook()" name="agg-submit" id="agg-submit" class="stakeholders-btn" />
              <!-- Button trigger modal -->
              <button type="button" class="stakeholders-btn" data-bs-toggle="modal" data-bs-target="#exampleModal" id="util-5-fb-btn" name="util-5-fb-btn" style="margin-left:10px; background-color: blue;">
                Leave a comment
              </button>
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
      <li class="page-item" id="pag-prev-1">
        <a class="page-link" href="utilitarianism-3rd-option.html" aria-label="Previous">
          <span aria-hidden="true">&laquo;</span>
          <span class="sr-only">Previous</span>
        </a>
      </li>
      <li class="page-item" id="pag-prev-2">
        <a class="page-link" href="utilitarianism-4.html" aria-label="Previous">
          <span aria-hidden="true">&laquo;</span>
          <span class="sr-only">Previous</span>
        </a>
      </li>
