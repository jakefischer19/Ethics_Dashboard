...
if (isset($_POST['save'])) {
  ...
  $sql = "UPDATE cases SET option1= ?, option2= ?, option3 = ? WHERE caseID= ?";
  $save_sql = $db_connection->prepare($sql);
  $save_sql->bind_param("sssi", $option1, $option2, $option3, $caseID);
  $save_sql->execute();
...
<body onload="loadOptions();">
            ...
            <div class="col-lg p-2">
              <div class="card">
                <div class="card-body">
                  ...
                  <textarea disabled name="ethical" id="case-summary" cols="15" rows="14" placeholder="I am the engineer who is asked to create the VW defeat device. It will make it possible for vehicles to pass emissions tests designed to protect the environment. I’m not  sure I should do it because it seems wrong to cheat."></textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg p-2">
          <div class="card h-100">
            <div class="card-body" style="height: 580px; overflow-y: auto">
              ...
              <textarea name="option1" id="option1" cols="14" rows="9" placeholder="I can put loyalty to the company above my personal concerns and do my job – create the device." onchange="getOptions1Title()"></textarea>
              <br /><br />
              <h4 class="pb-2">OPTION 2</h4>
              <textarea name="option2" id="option2" cols="14" rows="9" placeholder="I can betray the company, go to the press and blow the whistle." onchange="getOptions2Title()"></textarea>
              <br /><br />
              <h4 class="pb-2">OPTION 3</h4>
              <textarea name="option3" id="option3" cols="14" rows="9" placeholder="Enter your option here" onchange="getOptions3Title();incCounter()"></textarea>
              <br /><br />
              ...
              <div class="button-wrapper">
                ...
                <input type="submit" name="save" value="Save" class="options-btn ms-1" onclick="sendOptions();unhook()" />
                <input type="button" value="Go back" onclick="goBack()" class="options-btn ms-1" />
              </div>
            </div>
          </div>
        </div>
  ...
  <center><input type="button" class="stakeholders-btn ms-2 mt-5" value="Go back" onclick="goBack()"></center>
