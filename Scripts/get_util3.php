...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    array_push($returnArr, $row["st_o1_slider4"]);
    array_push($returnArr, $row["st_o1_slider5"]);
    array_push($returnArr, $row["st_o1_slider6"]);
    ...
    array_push($returnArr, $row["st_o1_slider_txt_4"]);
    array_push($returnArr, $row["st_o1_slider_txt_5"]);
    array_push($returnArr, $row["st_o1_slider_txt_6"]);
    array_push($returnArr, $row["st_o1_radio1"]);
    array_push($returnArr, $row["st_o1_radio2"]);
    array_push($returnArr, $row["st_o1_radio3"]);
    array_push($returnArr, $row["st_o1_radio4"]);
    array_push($returnArr, $row["st_o1_radio5"]);
    array_push($returnArr, $row["st_o1_radio6"]);
    array_push($returnArr, $row["lt_o1_slider1"]);
    array_push($returnArr, $row["lt_o1_slider2"]);
    array_push($returnArr, $row["lt_o1_slider3"]);
    array_push($returnArr, $row["lt_o1_slider4"]);
    array_push($returnArr, $row["lt_o1_slider5"]);
    array_push($returnArr, $row["lt_o1_slider6"]);
    ...
    array_push($returnArr, $row["lt_o1_slider_txt_4"]);
    array_push($returnArr, $row["lt_o1_slider_txt_5"]);
    array_push($returnArr, $row["lt_o1_slider_txt_6"]);
