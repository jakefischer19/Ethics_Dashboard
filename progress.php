...
<body>
    ...
    <div class="card">
      <div class="card-body">
            ...
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  ...
                  <input type="number" class="text-1" id="text-1" placeholder="/10" min="0" max="10" maxlength="2" onchange="valueChange()" required onkeyup="this.value = minmax(this.value, 0, 10)" />
                </h4>
                <textarea name="progress-1" id="progress-1" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  DEONTOLOGY
                  <input type="number" class="text-1" id="text-2" placeholder="/15" min="0" max="15" onchange="valueChange2()" maxlength="2" required onkeyup="this.value = minmax2(this.value, 0, 15)" />
                </h4>
                <textarea name="progress-2" id="progress-2" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row p-2">
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  STAKEHOLDERS
                  <input type="number" class="text-1" id="text-3" placeholder="/10" min="0" max="10" onchange="valueChange3()" maxlength="2" required onkeyup="this.value = minmax(this.value, 0, 10)" />
                </h4>
                <textarea name="progress-3" id="progress-3" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  UTILITARIANISM
                  <input type="number" class="text-1" id="text-4" placeholder="/15" min="0" max="15" onchange="valueChange4()" maxlength="2" required onkeyup="this.value = minmax2(this.value, 0, 15)" />
                </h4>
                <textarea name="progress-4" id="progress-4" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row p-2">
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  VIRTUE ETHICS
                  <input type="number" class="text-1" id="text-5" placeholder="/15" min="0" max="15" onchange="valueChange5()" maxlength="2" required onkeyup="this.value = minmax2(this.value, 0, 15)" />
                </h4>
                <textarea name="progress-5" id="progress-5" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="textarea-container">
                <h4 class="pb-2">
                  CARE ETHICS
                  <input type="number" class="text-1" id="text-6" min="0" max="15" placeholder="/15" onchange="valueChange6()" maxlength="2" required onkeyup="this.value = minmax2(this.value, 0, 15)" />
                </h4>
                <textarea name="progress-6" id="progress-6" cols="10" rows="7" placeholder="Comments Summary: This summary lists all comments posted in-text by the marker"></textarea>
              </div>
            </div>
          </div>
        </div>
        <div class="row p-2 justify-content-center">
          ...
          <input type="submit" name="calc-grade" id="calc-grade" value="Calculate Grades" class="stakeholders-btn" onclick="assignValue();assignValue2();assignValue3();assignValue4();assignValue5();assignValue6();" />
        </div>
        <br />
  ...
  <div class="d-grid gap-2">
    <center><button class="btn btn-secondary col-3" type="button" onclick="loadVar();" id="generateBtn">
        Generate Report
      </button></center>
    <!-- Libraries -->
