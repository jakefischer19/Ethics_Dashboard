...
<body onload="load();">
  ...
  <form action="utilitarianism-3.php" method="POST">
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-body" style="height: 600px; overflow-y: auto">
          <h4 class="p-2">
            <center>
              OPTION 1 -
              <span class="option1-title" id="option1-title" style="color: grey">
          ...
          <div class="row p-2" id="st-o1-stakeholder-1">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-1" name="st-o1-slider-1" onchange="stGetValue()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-1" name="st-o1-slider-txt-1" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-1" id="st-o1-radio-1" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-1" id="st-o1-radio-2" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="st-o1-stakeholder-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-2" name="st-o1-slider-2" onchange="stGetValue2()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-2" name="st-o1-slider-txt-2" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-2" id="st-o1-radio-3" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-2" id="st-o1-radio-4" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="st-o1-stakeholder-3">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-3" name="st-o1-slider-3" onchange="stGetValue3()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-3" name="st-o1-slider-txt-3" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-3" id="st-o1-radio-5" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-3" id="st-o1-radio-6" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="st-o1-stakeholder-4">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-4" name="st-o1-slider-4" onchange="stGetValue4()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-4" name="st-o1-slider-txt-4" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-4" id="st-o1-radio-7" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-4" id="st-o1-radio-8" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="st-o1-stakeholder-5">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-5" name="st-o1-slider-5" onchange="stGetValue5()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-5" name="st-o1-slider-txt-5" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-5" id="st-o1-radio-9" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-5" id="st-o1-radio-10" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="st-o1-stakeholder-6">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="st-o1-slider-6" name="st-o1-slider-6" onchange="stGetValue6()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="st-o1-slider-txt-6" name="st-o1-slider-txt-6" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="st-o1-radio-6" id="st-o1-radio-11" value="High" onclick="stCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="st-o1-radio-6" id="st-o1-radio-12" value="Low" onclick="stCountLow()" />
              </h5>
            </div>
          </div>
          <hr style="color: black; height: 2px" />
          ...
          <div class="row p-2" id="lt-o1-stakeholder-1">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-1" name="lt-o1-slider-1" onchange="ltGetValue()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-1" name="lt-o1-slider-txt-1" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-1" id="lt-o1-radio-1" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-1" id="lt-o1-radio-2" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="lt-o1-stakeholder-2">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-2" name="lt-o1-slider-2" onchange="ltGetValue2()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-2" name="lt-o1-slider-txt-2" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-2" id="lt-o1-radio-3" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-2" id="lt-o1-radio-4" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="lt-o1-stakeholder-3">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-3" name="lt-o1-slider-3" onchange="ltGetValue3()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-3" name="lt-o1-slider-txt-3" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-3" id="lt-o1-radio-5" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-3" id="lt-o1-radio-6" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="lt-o1-stakeholder-4">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-4" name="lt-o1-slider-4" onchange="ltGetValue4()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-4" name="lt-o1-slider-txt-4" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-4" id="lt-o1-radio-7" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-4" id="lt-o1-radio-8" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="lt-o1-stakeholder-5">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-5" name="lt-o1-slider-5" onchange="ltGetValue5()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-5" name="lt-o1-slider-txt-5" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-5" id="lt-o1-radio-9" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-5" id="lt-o1-radio-10" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <div class="row p-2" id="lt-o1-stakeholder-6">
            ...
            <div class="col-lg p-2">
              <div class="border">
                <h6 class="pt-2">
                  Pleasure
                  <input type="range" min="1" max="100" value="0" class="slider" id="lt-o1-slider-6" name="lt-o1-slider-6" onchange="ltGetValue6()" />
                  Pain
                </h6>
              </div>
            </div>
            <div class="col-lg p-2">
              <div class="util-3-text">
                <input type="text" id="lt-o1-slider-txt-6" name="lt-o1-slider-txt-6" class="text-class" placeholder="Explain the selection" />
              </div>
              <h5 class="p-2">
                Pleasure:&ensp;<label>High</label>
                <input type="radio" name="lt-o1-radio-6" id="lt-o1-radio-11" value="High" onclick="ltCountHigh()" />&emsp; <label>Low</label>
                <input type="radio" name="lt-o1-radio-6" id="lt-o1-radio-12" value="Low" onclick="ltCountLow()" />
              </h5>
            </div>
          </div>
          <hr style="color: black; height: 2px" />
      ...
      <div class="row justify-content-center">
        <input type="submit" value="Save" id="st-o1-submit" name="st-o1-submit" class="stakeholders-btn mt-4" onclick="stValueSenderRadioButtonHigh();ltValueSenderRadioButtonHigh();stValueSenderRadioButtonLow();ltValueSenderRadioButtonLow();valueSender();unhook()" />
      </div>
    </div>
  </form>
  <br />
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
      <li class="page-item">
        <a class="page-link" href="utilitarianism-2.php" aria-label="Previous">
      ...
      <li class="page-item">
        <a class="page-link" href="utilitarianism-4.php" aria-label="Next">
    ...
    function load() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var s5_name = data[7];
          var s6_name = data[8];
          var st_o1_slider1 = data[9];
          var st_o1_slider2 = data[10];
          var st_o1_slider3 = data[11];
          var st_o1_slider4 = data[12];
          var st_o1_slider5 = data[13];
          var st_o1_slider6 = data[14];
          var st_o1_slider_txt_1 = data[15];
          var st_o1_slider_txt_2 = data[16];
          var st_o1_slider_txt_3 = data[17];
          var st_o1_slider_txt_4 = data[18];
          var st_o1_slider_txt_5 = data[19];
          var st_o1_slider_txt_6 = data[20];
          var st_o1_radio1 = data[21];
          var st_o1_radio2 = data[22];
          var st_o1_radio3 = data[23];
          var st_o1_radio4 = data[24];
          var st_o1_radio5 = data[25];
          var st_o1_radio6 = data[26];
          var lt_o1_slider1 = data[27];
          var lt_o1_slider2 = data[28];
          var lt_o1_slider3 = data[29];
          var lt_o1_slider4 = data[30];
          var lt_o1_slider5 = data[31];
          var lt_o1_slider6 = data[32];
          var lt_o1_slider_txt_1 = data[33];
          var lt_o1_slider_txt_2 = data[34];
          var lt_o1_slider_txt_3 = data[35];
          var lt_o1_slider_txt_4 = data[36];
          var lt_o1_slider_txt_5 = data[37];
          var lt_o1_slider_txt_6 = data[38];
          var lt_o1_radio1 = data[39];
          var lt_o1_radio2 = data[40];
          var lt_o1_radio3 = data[41];
          var lt_o1_radio4 = data[42];
          var lt_o1_radio5 = data[43];
          var lt_o1_radio6 = data[44];
          ...
          document.getElementById("st-o1-slider-4").value = st_o1_slider4;
          document.getElementById('st-o1-slider-5').value = st_o1_slider5;
          document.getElementById('st-o1-slider-6').value = st_o1_slider6;
          ...
          document.getElementById('st-o1-slider-txt-4').value = st_o1_slider_txt_4;
          document.getElementById('st-o1-slider-txt-5').value = st_o1_slider_txt_5;
          document.getElementById('st-o1-slider-txt-6').value = st_o1_slider_txt_6;
          ...
          if (st_o1_radio4 == "High") {
            document.getElementById('st-o1-radio-7').checked = true;
          } else {
            document.getElementById('st-o1-radio-8').checked = true;
          }
          if (st_o1_radio5 == "High") {
            document.getElementById('st-o1-radio-9').checked = true;
          } else {
            document.getElementById('st-o1-radio-10').checked = true;
          }
          if (st_o1_radio6 == "High") {
            document.getElementById('st-o1-radio-11').checked = true;
          } else {
            document.getElementById('st-o1-radio-12').checked = true;
          }
          ...
          document.getElementById('lt-o1-slider-4').value = lt_o1_slider4;
          document.getElementById('lt-o1-slider-5').value = lt_o1_slider5;
          document.getElementById('lt-o1-slider-6').value = lt_o1_slider6;
          ...
          document.getElementById('lt-o1-slider-txt-4').value = lt_o1_slider_txt_4;
          document.getElementById('lt-o1-slider-txt-5').value = lt_o1_slider_txt_5;
          document.getElementById('lt-o1-slider-txt-6').value = lt_o1_slider_txt_6;
          ...
          if (lt_o1_radio4 == "High") {
            document.getElementById('lt-o1-radio-7').checked = true;
          } else {
            document.getElementById('lt-o1-radio-8').checked = true;
          }
          if (lt_o1_radio5 == "High") {
            document.getElementById('lt-o1-radio-9').checked = true;
          } else {
            document.getElementById('lt-o1-radio-10').checked = true;
          }
          if (lt_o1_radio6 == "High") {
            document.getElementById('lt-o1-radio-11').checked = true;
          } else {
            document.getElementById('lt-o1-radio-12').checked = true;
          }
        },
