<?php
    ...
    if (isset($_POST['util-1-submit'])) {
      ...
      $sql = "UPDATE util SET o1_response= ?, o2_response= ? WHERE caseID= ?";
      $save_sql = $db_connection->prepare($sql);
      $save_sql->bind_param("ssi", $o1_response, $o2_response, $caseID);
      $save_sql->execute();
              ...
              <div class="card-body">
                <div class="row p-2">
                  <div class="col-lg p-2">
                    ...
                    <textarea
                      name="util_option1_response"
                      id="util_option1_response"
                      cols="10"
                      rows="7"
                      placeholder="Short term – personal guilt but I keep my job – the consumers are betrayed – the environment is damaged

  Long term - If the device is discovered I will likely lose my job and possibly my career – VW’s reputation, and business, will be damaged"
                    ></textarea>
                  </div>
                </div>
                <br />
                  ...
                  <div class="col-lg p-2">
                    <h4 class="pb-2">
                      ...
                      <span 
                        ...
                        id="option2-title" 
                        style="color: grey"
                        >Option 2 displays here</span
                      >
                    </h4>
                    <textarea
                      name="util_option2_response"
                      id="util_option2_response"
                      cols="10"
                      rows="7"
                      placeholder="Short term – I will have done the right thing, but I will likely lose my job and possibly my career. The device will not be built and that will have a negative impact on VW’s ability to produce certain types of vehicles.
                      
  Long term – I will feel good knowing that I did the right thing – consumers will not be betrayed – the environment is protected"
                    ></textarea>
                  </div>
                </div>
                <br />
                  ...
                  <div class="col-lg p-2">
                    <h4 class="pb-2">
                      ...
                      <span
                        ...
                        id="option3-title"
                        style="color: grey"
                        >Option 3 displays here</span
                      >
                    </h4>
                    <textarea
                      name="util_option3_response"
                      id="util_option3_response"
                      cols="10"
                      rows="7"
                      placeholder="Short term – I will have done the right thing, but I will likely lose my job and possibly my career. The device will not be built and that will have a negative impact on VW’s ability to produce certain types of vehicles.
  ...
  Long term – I will feel good knowing that I did the right thing – consumers will not be betrayed – the environment is protected"
                ...
                <div class="row ms-1 justify-content-center">
                  ...
                  <input
                    ...
                    onclick="sendOptionsCounter();unhook()"
                  />
                </div>
              </div>
            </div>
      ...
      function loadOptions() {
        ...
        $.ajax({
          ...
          success: function(data){
            var o1_name = data[0];
            var o2_name = data[1];
            var o1_response = data[2];
            var o2_response = data[3];
