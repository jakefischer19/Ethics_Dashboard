<?php
    ...
    if (isset($_POST['save'])) {
      ...
      $sql = "UPDATE stakeholders SET s1_name= ?, s1_interests= ?, s2_name= ?, s2_interests= ?, s3_name= ?, s3_interests= ? WHERE caseID= ?";
      $save_sql = $db_connection->prepare($sql);
      $save_sql->bind_param("ssssssi", $s1_name, $s1_interests, $s2_name, $s2_interests, $s3_name, $s3_interests, $caseID);
      $save_sql->execute();
  ...
  <body onload="loadStakeholders();">
    ...
    <form action="stakeholders.php" method="POST">
      <div class="container-fluid">
        <center><h3 class="pb-2">STAKEHOLDER ANALYSIS</h3></center>
        <br />
        <div class="card">
          <div class="card-body">
            ...
            <div class="row p-2">
              ...
              <div class="col-lg p-2">
                ...
                <textarea
                  ...
                  cols="10"
                  rows="7"
                  placeholder="Professional success, job security, a clear conscience."
                ></textarea>
              </div>
            </div>
            ...
            <div class="row p-2">
              ...
              <div class="col-lg p-2">
                ...
                <textarea
                  ...
                  cols="10"
                  rows="7"
                  placeholder="Increase Profit, Satisfy Consumer needs"
                ></textarea>
              </div>
            </div>
            ...
            <div class="row p-2">
              ...
              <div class="col-lg p-2">
                ...
                <textarea
                  ...
                  cols="10"
                  rows="7"
                  placeholder="A 'green' vehicle, a clear conscience, social status"
                ></textarea>
              </div>
            </div>
